...
<section>
    <body>
        <div class="container block-7" style="background-color:#FFF; border: 1px solid black !important; max-width: 600px !important">
            ...
            <form method="POST" action="{{ route('healthstaff.login') }}">
                @csrf
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <x-input id="name" class="form-control" type="text" name="name" :value="old('name')" required placeholder="Username" autofocus/>
                        </div>
                    </div>
                    <div class="col-md-12">
                        <div class="form-group">
