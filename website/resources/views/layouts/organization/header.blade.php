			...
			@auth('business')
				<div class="collapse navbar-collapse" id="ftco-nav" >
					<ul class="navbar-nav" style="font-weight:600 !important">
						<li class="nav-item {{ Request::segment(2) === 'overview' ? 'active' : null }}"><a href="{{url('business/overview')}}" class="nav-link">Overview</a></li>
						<li class="nav-item {{ Request::segment(2) === 'alerts' ? 'active' : null }}"><a href="{{url('business/alerts')}}" class="nav-link">Alerts</a></li>
						...
						<li class="nav-item {{ Request::segment(2) === 'profile' ? 'active' : null }}"><a href="{{url('business/profile')}}" class="nav-link">Manage Account</a></li>
					</ul>
				</div>
				@endauth
			</div>
