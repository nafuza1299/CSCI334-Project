<div class="wrap">
		...
		<div class="container">
			...
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item {{ Request::segment(1) === 'about' ? 'active' : null }}"><a href="{{url('about')}}" class="nav-link">About</a></li>
				<li class="nav-item {{ Request::segment(1) === 'counselor' ? 'active' : null }}"><a href="{{url('counselor')}}" class="nav-link">Counselor</a></li>
